...
function Textarea({ children, ...props }, ref) {
  return (
    <CONTAINER ref={ref} name={props.name} width={props.width} height={props.height} fontSize={props.fontSize} corner={props.corner} padding={props.padding} margin={props.margin} placeholder={props.placeholder} onClick={props.onClick}>
      {children}
    </CONTAINER>
  );
}
